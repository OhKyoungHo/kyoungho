                      ...
                      <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                        <div class="course__item white-bg mb-30 fix">
                          ...
                          <div class="course__content">
                            ...
                            <h3 class="course__title">
                              <a href="course-details">Bases Matemáticas dios Álgebra Ecuacion</a>
                            </h3>
                            <div class="course__teacher d-flex align-items-center">
                              <div class="course__teacher-thumb mr-15">
                                <img src="assets/img/course/teacher/teacher-7.jpg" alt="" />
                              </div>
                              <h6><a href="instructor-details">Samuel Serif</a></h6>
                            </div>
                          </div>
                          <div
                            class="course__more d-flex justify-content-between align-items-center"
                        ...
                        <div class="course__item white-bg mb-30 fix">
                          ...
                          <div class="course__content">
                            ...
                            <div class="course__teacher d-flex align-items-center">
                              ...
                              <h6><a href="instructor-details">Brian Cumin</a></h6>
                            </div>
                          </div>
                          <div
                            class="course__more d-flex justify-content-between align-items-center"
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8">
                              <div class="course__right">
                                <div class="course__content course__content-3">
                                  ...
                                  <h3 class="course__title course__title-3">
                                    <a href="course-details"
                                      >Fundamentals of music theory Learn new.</a
                                    >
                                  </h3>
                                  <div class="course__summary">
                                    <p>
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8">
                              <div class="course__right">
                                <div class="course__content course__content-3">
                                  ...
                                  <h3 class="course__title course__title-3">
                                    <a href="course-details"
                                      >Strategy law and organization Foundation</a
                                    >
                                  </h3>
                                  <div class="course__summary">
                                    <p>
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8">
                              <div class="course__right">
                                <div class="course__content course__content-3">
                                  ...
                                  <h3 class="course__title course__title-3">
                                    <a href="course-details"
                                      >Build your media and Public presence</a
                                    >
                                  </h3>
                                  <div class="course__summary">
                                    <p>
                            ...
                            <div class="col-xxl-8 col-xl-8 col-lg-8">
                              <div class="course__right">
                                <div class="course__content course__content-3">
                                  ...
                                  <h3 class="course__title course__title-3">
                                    <a href="course-details"
                                      >Creative writing through Storytelling</a
                                    >
                                  </h3>
                                  <div class="course__summary">
                                    <p>
