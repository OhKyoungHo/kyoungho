                        ...
                        <tr>
                          ...
                          <td class="iValue" colspan="2">
                            <input
                              type="hidden"
                              name="vcKeyword"
                              value="${lectureList.vcKeyword}"
                            />${lectureList.vcKeyword}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td class="iValue" colspan="2">
                            <input
                              type="hidden"
                              name="vcIntro"
                              value="${lectureList.vc_intro}"
                            />${lectureList.vc_intro}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="iValue" colspan="2">
                            <input
                              type="hidden"
                              name="vc_content"
                              value="${lectureList.vc_content}"
                            />${lectureList.vc_content}
                          </td>
                        </tr>
                        <tr>
