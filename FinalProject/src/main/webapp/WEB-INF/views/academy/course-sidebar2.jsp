                        ...
                        <div class="tab-content" id="courseTabContent">
                                 ...
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="course__item white-bg mb-30 fix">
                                       ...
                                       <div class="course__content">
                                          ...
                                          <!--변수명에 _가 있는 경우에는 오류 발생 -> 낙타식표기법으로 변경함-->
                         ...
                         <div class="row">
                                 ...
                                 <ul class="d-flex align-items-center"> 
                                    ...
                                    <!-- 맨처음페이지로 이동 -->
			                           <c:choose>
				                        ...
				                        <c:otherwise>
                                    <li class="prev">
                                       <a href="course-sidebar2?page=1" class="link-btn link-prev">
                                          Prev
                           ...
                           <!-- 현재페이지의 +1이 i랑 다른 경우 다음 페이지로 이동하게 설정-->
                              ...
                              <li>
                                 <a href="course-sidebar2?page=${i}"><span>${i}</span></a>
                              </li>
                           </c:when>
                           <c:otherwise>
                              <li><a href="course-sidebar2?page=${i}"><span>${i}</span></a></li>
                           </c:otherwise>
                           </c:choose>
                           </c:forEach>
                           <!-- 맨마지막페이지 -->
                           ...
                           <!-- 마지막페이지로 이동 -->
			                  <c:choose>     
				               ...
				               <c:otherwise>
                              <li class="next">
                                 <a href="course-sidebar2?page=${totalPages}" class="link-btn">
                                 Next
