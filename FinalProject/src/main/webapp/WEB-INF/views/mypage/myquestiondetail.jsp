      ...
      <section class="cart-area pt-100 pb-100">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div>
                <p class="title text-center mb-40" style="text-transform: capitalize; font-family: 'Noto Sans KR', sans-serif; font-size: 27pt; font-weight: bolder;">
                    1대1 문의</p>
                </div>
                <div calss="qnatitle">
                <h2 >1대1문의제목</h2>
              ...
              <div class="blog-post-area">
                ...
                <table class="qnaTable mt-20" id="qnaTable">
								
									<tr style="height:30px;">
										<th class="qnath" >작성자</th>
										<td name="qna_writer" class="qnatd"
											value=<%=session.getAttribute("login")%> readonly>안녕나는경주야</td>
                    <th class="qnath" >작성날짜</th>
                    <td class="qnatd">경주야잘하자</td>
                  </tr>
                  
								</table>
                <div class="qnacontent">
                  <p>sssssssssssssssssssssssssssssssssssssssssssssssssssssss</p></div>
              </div>
              <div class="qnambtn">
