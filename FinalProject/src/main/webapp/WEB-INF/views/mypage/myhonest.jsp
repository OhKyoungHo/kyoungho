          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="accounthead mb-25">
                 <h2 class="section__title "><span class="yellow-bg-sm">My 솔직답변리스트<img src="../assets/img/shape/yellow-bg-4.png" style="height:50px;"alt="">  </span></h2>
              </div>
                 <form action="#">
                      ...
                      <table id="qnaTable" class="reviweTable">
                        <thead>
                          <tr>
                            ...
                            <th style="width:10%;">응답여부</th>
                          </tr>
                        </thead>
                        <tbody>
                            <tr>
                              <td>솔직번호</td>
                              <td><a href="../mypage/myhonestdetail">솔직제목</a></td>
                              <td>솔직일자</td>
                              <td>솔직안함</td>
                            </tr>
                        </tbody>
