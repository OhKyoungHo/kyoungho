                       ...
                       >
                         ...
                         <li class="nav-item">
                           ...
                           <div id="collapseThree" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                             <div class="bg-white py-2 collapse-inner rounded">
                               <a class="collapse-item" href="/mypage/wishlist?memIdInt=${sessionScope.memIdInt}">관심학원리스트</a><br/> 
                               <a class="collapse-item" href="/mypage/jjimlist?memIdInt=${sessionScope.memIdInt}">관심강의리스트</a>
                             </div>
                           </div>
                         </li>
                         <li class="nav-item">
                              ...
                              <table class="table">
                                    <thead>
                                       <tr>
                                          ...
                                          <th class="product-subtotal">상세보기</th>
                                          <th class="product-remove">Remove</th>
                                       </tr>
                                    </thead>
                                    <c:forEach items="${wishList}" var="wish">
                                       <form action="/deletetWish?wId=${wish[1]}">
                                    <tbody>
                                       <tr>
                                          <td class="product-thumbnail"><a href="course-details"><img src="/assets/img/course/${wish[4]}" alt="" style="width: 100px; height: 100px;"></a></td>
                                          <td class="product-name" style="width:300px"><a href="/academy/course-details?edId=${wish[5]}">${wish[0]}</a></td>
                                          <td class="product-price" style="width:60px"><span class="amount">${wish[3]}</span></td>
                                         
                                          <td class="product-quantity" style="width:250px">
                                             <span class="amount">${wish[6]} ~ ${wish[7]} </span>  
                                          </td>
                                          <td class="product-subtotal" style="width:120px"> <button class="e-btn e-btn-border" type='button' onclick="location.href='/academy/course-details?edId=${wish[5]}'">보기</button></td>
                                          <td class="product-remove" id="removebtn"><a href="/mypage/deleteWish?memIdInt=${wish[2]}&wId=${wish[1]}"><i class="fa fa-times"></i></a></td>
                                       </tr>
                                    </tbody>
                                    </c:forEach>
                              </table>
