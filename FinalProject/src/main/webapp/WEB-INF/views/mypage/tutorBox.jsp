          ...
          <div class="row">
            <div class="col-xxl-12">
              <div class="page__title-wrapper mt-110">
                <h3 class="page__title">수업함</h3>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">수업함</li>
                  </ol>
                </nav>
              </div>
            </div>
                                  ...
                                  <td class="tb-middle">
                                    <c:forEach items="${tutorRecord}" var="TR">
                                      <c:if test="${TR.calId eq TB.cal_id}">
                                        <a href="${TR.recName}" download="${TR.origRecName}">${TR.origRecName}</a> <br/>
                                      </c:if>
                                    </c:forEach>
                                  </td>
                                  <td class="tb-middle">
                                    <c:forEach items="${tutorFile}" var="TF">
                                      <c:if test="${TF.calId eq TB.cal_id}">
                                        <a href="${TF.fileName}" download="${TF.origFileName}">${TF.origFileName}</a> <br/>
                                      </c:if>
                                    </c:forEach>
                                    <a href="#" class="add-file" aria-label="add-file">
                                      <span class="add-file-sp" aria-hidden="true"><i class="fa fa-plus"></i></span>
                                    </a>
                                  </td>
                                </tr>
                              </c:forEach>
