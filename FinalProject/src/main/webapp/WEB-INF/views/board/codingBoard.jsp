   ...
   <!-- header area end -->
      ...
      <main>
               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-110">
                        <h3 class="page__title">코딩게시판</h3>                         
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              <!--홈으로 이동하기 위해 index-2로 링크-->
                              <li class="breadcrumb-item"><a href="/academy/index">main</a></li>
                              <li class="breadcrumb-item active" aria-current="page">코딩게시판</li>
                           </ol>
                        </nav>
                     </div>
                  </div>
         ...
         <section class="course__area pt-120 pb-120">
            <div class="container">   
               <div row>
               <iframe scrolling="no" src="https://rextester.com/l/java_online_compiler" style="height: 800px; width: 100%;"></iframe>
               </div>
            </div>
         </section>
         <!-- course area end -->
