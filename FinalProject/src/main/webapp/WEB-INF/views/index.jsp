              ...
              <div class="section__title-wrapper mb-45">
                <h2 class="section__title">
                  ...
                  <span class="yellow-bg"
                    >Popular <img src="assets/img/shape/yellow-bg-2.png" alt="" /> </span
                  >Courses
                </h2>
              </div>
            </div>
                ...
                >
                  <div class="events__content">
                    ...
                    <h3 class="events__title">
                      <a href="event-details">Digital transformation conference</a>
                    </h3>
                  </div>
              ...
              <div class="events__item mb-10 hover__active active">
                ...
                >
                  <div class="events__content">
                    ...
                    <h3 class="events__title">
                      <a href="event-details">World education day conference</a>
                    </h3>
                  </div>
                  <div class="events__more">
                    <a href="event-details" class="link-btn">
              ...
              <div class="events__item mb-10 hover__active">
                ...
                >
                  <div class="events__content">
                    ...
                    <h3 class="events__title">
                      <a href="event-details">Foundations of global health</a>
                    </h3>
                  </div>
                  <div class="events__more">
                    <a href="event-details" class="link-btn">
              ...
              <div class="events__item mb-10 hover__active">
                ...
                >
                  <div class="events__content">
                    ...
                    <h3 class="events__title">
                      <a href="event-details">Business creativity workshops</a>
                    </h3>
                  </div>
                  <div class="events__more">
                    <a href="event-details" class="link-btn">
