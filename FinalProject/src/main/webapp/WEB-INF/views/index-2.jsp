...
<html class="no-js" lang="zxx">
  ...
  <body>
    ...
    <main>
                ...
                <div class="hero__content hero__content-2 p-relative z-index-1">
                  <h3 class="hero__title hero__title-2">
                    ...
                    <span class="yellow-shape"
                      >online <img src="assets/img/shape/yellow-bg.png" alt="yellow-shape" />
                    </span>
                    learning Platform
                  </h3>
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="hero__thumb-wrapper mb--120">
                  <div class="hero__thumb-2 scene">
                    ...
                    <div
                      class="hero__promotion education d-none d-lg-flex white-bg layer"
                      data-depth="0.2"
                    >
              ...
              <div class="section__title-wrapper section-padding mb-60 text-center">
                <h2 class="section__title">
                  ...
                  <span class="yellow-bg"
                    >scholercity <img src="assets/img/shape/yellow-bg-2.png" alt=""
                  /></span>
                  out of The ordinary
                </h2>
              ...
              <div class="section__title-wrapper mb-60 text-center">
                <h2 class="section__title">
                  ...
                  <span class="yellow-bg-big"
                    >Skilline? <img src="assets/img/shape/yellow-bg-2.png" alt=""
                  /></span>
                </h2>
                <p>
                  Sloshed faff about me old mucker blatant bubble and squeak hanky panky some dodgy
                  chav bevvy arse chimney pot I, ruddy plastered buggered smashing blow off I'm
                  telling up the kyver he legged it bleeder jolly good,
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-xxl-5 offset-xl-1 col-xl-5 offset-xl-1 col-lg-6">
              <div class="what__item transition-3 mb-30 p-relative fix">
                ...
                <div class="what__content p-absolute text-center">
                  <h3 class="what__title white-color">
                    Mostly <br />
                    Online Learning
                  </h3>
                  <a href="contact" class="e-btn e-btn-border-2">Start a class today</a>
                </div>
              </div>
            </div>
            <div class="col-xxl-5 col-xl-5 col-lg-6">
              <div class="what__item transition-3 mb-30 p-relative fix">
                ...
                <div class="what__content p-absolute text-center">
                  ...
                  <a href="contact" class="e-btn e-btn-border-2">Start teaching</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
              <div class="section__title-wrapper text-center mb-60">
                <h2 class="section__title">
                  We are
                  <span class="yellow-bg yellow-bg-big"
                    >Proud<img src="assets/img/shape/yellow-bg.png" alt=""
                  /></span>
                </h2>
                <p>You don't have to struggle alone, you've got our assistance and help.</p>
              </div>
      ...
      <section
        class="testimonial__area testimonial__overlay pt-175 pb-170"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
                <div class="cta__apps d-lg-flex justify-content-end p-relative z-index-1">
                  <a target="_blank" href="https://www.apple.com/app-store/" class="mr-10"
                    ><i class="fab fa-apple"></i> Apple Store</a
                  >
                  <a target="_blank" href="https://play.google.com/store/apps" class="active"
