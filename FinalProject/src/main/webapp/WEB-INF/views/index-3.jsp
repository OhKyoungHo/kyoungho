...
<html class="no-js" lang="zxx">
  ...
  <body>
    ...
    <main>
      ...
      <section class="slider__area p-relative">
        <div class="slider__wrapper swiper-container">
          <div class="swiper-wrapper">
            <div
              class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center"
                    ...
                    <div class="slider__content">
                      ...
                      <h3 class="slider__title">
                        ...
                        <span class="yellow-bg"
                          >tutor <img src="assets/img/shape/yellow-bg.png" alt="" />
                        </span>
                        for you.
                      </h3>
                      <p>
                  ...
                  <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                    <div class="slider__content">
                      ...
                      <h3 class="slider__title">
                        ...
                        <span class="yellow-bg"
                          >theory <img src="assets/img/shape/yellow-bg.png" alt="" />
                        </span>
                        Learn
                      </h3>
                      <p>
                  ...
                  <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                    <div class="slider__content">
                      ...
                      <h3 class="slider__title">
                        Become a product
                        <span class="yellow-bg"
                          >Manager <img src="assets/img/shape/yellow-bg.png" alt="" />
                        </span>
                        & learn.
                      </h3>
                      <p>
                  ...
                  <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                    <div class="slider__content">
                      ...
                      <h3 class="slider__title">
                        Launch your
                        <span class="yellow-bg"
                          >online <img src="assets/img/shape/yellow-bg.png" alt="" />
                        </span>
                        learning Platform.
                      </h3>
                      <p>
        ...
        <div class="swiper-container slider__nav d-none d-md-block">
          <div class="swiper-wrapper">
            <div
              class="slider__nav-item swiper-slide orange-bg"
              data-background="assets/img/slider/nav/slider-nav-4.jpg"
            >
            ...
            <div
              class="slider__nav-item swiper-slide blue-bg"
              data-background="assets/img/slider/nav/slider-nav-1.jpg"
            >
              <div class="slider__nav-content">
                <span>4 Courses</span>
            ...
            <div
              class="slider__nav-item swiper-slide pink-bg"
              data-background="assets/img/slider/nav/slider-nav-2.jpg"
            >
              <div class="slider__nav-content">
                <span>8 Courses</span>
            ...
            <div
              class="slider__nav-item swiper-slide green-bg"
              data-background="assets/img/slider/nav/slider-nav-3.jpg"
            >
              <div class="slider__nav-content">
                <span>8 Courses</span>
                ...
                <div class="section__title-wrapper mb-25">
                  <h2 class="section__title">
                    Achieve your <br /><span class="yellow-bg-big"
                      >Goals <img src="assets/img/shape/yellow-bg-2.png" alt=""
                    /></span>
                    with Educal
                  </h2>
                  <p>
                    Lost the plot bobby such a fibber bleeding bits and bobs don't get shirty with
                    me bugger all mate chinwag super pukka william barney, horse play buggered.
                  </p>
                </div>
                <div class="about__list mb-35">
                  <ul>
                    <li class="d-flex align-items-center">
                      <i class="icon_check"></i> Upskill your organization.
                    </li>
                    <li class="d-flex align-items-center">
                      <i class="icon_check"></i> Access more then 100K online courses
                    </li>
                    <li class="d-flex align-items-center">
                      <i class="icon_check"></i> Learn the latest skills
                    </li>
                  </ul>
                </div>
          ...
          <div class="row">
              ...
              <div class="course__item course__item-2 white-bg mb-30 transition-3">
                ...
                <div class="course__content-2">
                  <h3 class="course__title-2">
                    <a href="course-details">Product Manager Learn the Skills & job.</a>
                  </h3>
                  <p>
                    Top instructors from around the world teach millions of students on Quillow. Get
                    unlimited.
                  </p>
                  <div class="course__bottom d-sm-flex justify-content-between align-items-center">
                    <div class="course__teacher-2 d-flex align-items-center">
                      <div class="course__teacher-thumb-2 mr-20">
                        <img src="assets/img/course/teacher/home-3/teacher-1.jpg" alt="" />
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div class="course__item course__item-2 white-bg mb-30 transition-3">
                ...
                <div class="course__content-2">
                  <h3 class="course__title-2">
                    <a href="course-details">The Importance Of Intrinsic for Students.</a>
                  </h3>
                  <p>
                    Top instructors from around the world teach millions of students on Quillow. Get
                    unlimited.
                  ...
                  <div class="course__bottom d-sm-flex justify-content-between align-items-center">
                    <div class="course__teacher-2 d-flex align-items-center">
                      <div class="course__teacher-thumb-2 mr-20">
                        <img src="assets/img/course/teacher/home-3/teacher-2.jpg" alt="" />
                        <div class="course__teacher-rating">
                          <i class="icon_star"></i>
                        </div>
                      </div>
            ...
            <div class="col-xxl-6 offset-xxl-3">
              <div class="section__title-wrapper text-center mb-60">
                <h2 class="section__title">
                  ...
                  Popular
                  <span class="yellow-bg">
                    Teachers <img src="assets/img/shape/yellow-bg-2.png" alt="" />
                  </span>
                  <br />
                </h2>
                <p>You don't have to struggle alone, you've got our assistance and help.</p>
      ...
      <section
        class="testimonial__area pt-145 pb-150"
                    ...
                    <div class="swiper-slide">
                      <div class="testimonial__item-3">
                        <p>
                          ...
                          improved to very advanced levels. While I am studying at my university, I
                          design as an additional income and I am sure that I will do this
                          professionally.”
                        </p>
              ...
              <div class="testimonial__video ml-70 fix">
                ...
                <div class="testimonial__video-content d-sm-flex">
                  ...
                  <div class="testimonial__video-text">
                    ...
                    <p>
                      Faff about A bit of how's your father getmate cack codswallop crikey
                      argy-bargy cobblers lost his bottle.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="section__title-wrapper mb-30">
                  ...
                  <h2 class="section__title">
                    ...
                    <span class="yellow-bg yellow-bg-big"
                      >Teachers<img src="assets/img/shape/yellow-bg.png" alt=""
                    /></span>
                    and Learners
                  </h2>
                  <p>
                    Oxford chimney pot Eaton faff about blower blatant brilliant, bubble and squeak
                    he legged it Charles bonnet arse at public school bamboozled.
                  </p>
                </div>
                <div class="why__btn">
            ...
            <div class="col-xxl-6 offset-xxl-3">
              <div class="section__title-wrapper text-center mb-60">
                <h2 class="section__title">
                  ...
                  Our
                  <span class="yellow-bg yellow-bg-big"
                    >thoughts <img src="assets/img/shape/yellow-bg.png" alt="" /></span
                  >on design
                </h2>
                <p>You don't have to struggle alone, you've got our assistance and help.</p>
              </div>
              ...
              <div class="blog__item white-bg mb-30 transition-3 fix">
                ...
                <div class="blog__content">
                  ...
                  <h3 class="blog__title">
                    <a href="blog-details">The Challenge Of Global Learning In Public Education</a>
                  </h3>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div class="blog__item white-bg mb-30 transition-3 fix">
                ...
                <div class="blog__content">
                  ...
                  <h3 class="blog__title">
                    <a href="blog-details">Exactly How Technology Can Make Reading Better</a>
                  </h3>
            ...
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              <div class="blog__item white-bg mb-30 transition-3 fix">
                ...
                <div class="blog__content">
                  ...
                  <h3 class="blog__title">
                    <a href="blog-details">New Chicago school budget relies on state pension</a>
                  </h3>
